...
public class MenuFactory {
    ...
    public static MenuDisplay createMenu(ApplicationContext context) {
        ...
        SelectFollowingCommand selectFollowingCommand = new SelectFollowingCommand(gitHubService, listService);
        ...
        menuController.registerCommand(5, selectFollowingCommand);
